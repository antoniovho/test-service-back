...
class TestPlanListResponse(BaseModel):
    """
    Paginated collection of test plan versions.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TestPlanListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TestPlanListResponse from a dict"""
        if obj is None:
            return None
