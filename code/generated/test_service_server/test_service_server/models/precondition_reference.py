...
class PreconditionReference(BaseModel):
    """
    Reference to an exact immutable precondition version with its business identity.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "preconditionKey", "version"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PreconditionReference from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PreconditionReference from a dict"""
        if obj is None:
            return None
